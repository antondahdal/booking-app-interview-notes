...
**From Week 4:** Part 1 Mon–Thu = coding LCs + one short [LC-SD](lc-sd-map.md). Friday LC-SD off.
...
| [lc-sd-map.md](lc-sd-map.md) | **Part 1 LC-SD** — from Week 4 Mon–Thu, 15 min after coding LCs |
...
| [week-05.md](week-05.md) | Gateway + resilience; Day 1–2 **closed** (timeout, retry, cache, immutability, click id) |
