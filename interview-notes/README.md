...
3. Before any LC: [lc-patterns.md](lc-patterns.md) — name pattern before code.
4. New days: paste the mentor block into **that week’s file** (template at the bottom of [cheats.md](cheats.md)).
...
| [week-03.md](week-03.md) | Concurrency — lock, `@Version`, race test, title PATCH |
