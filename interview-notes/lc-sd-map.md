...
| **W5 Tue** | Ch 13 — Auth practical. **Plus** cache on this app (extra, not a new chapter) | Login, token, who may call. Then cache until key / 10× / Book skips it | Full OAuth vendor sketch. `@Cacheable` code (W7 Wed) |
